...
services:
  pikachu:
    image: 8023/pikachu-expect:latest
    container_name: pikachu-expect
    ports:
      - "2003:80"
    restart: always
```
...
> WebGoat 是一个故意设计得不安全的 Web 应用程序，由[OWASP](http://www.owasp.org/)维护，旨在教授 Web 应用程序安全知识。[github](https://github.com/WebGoat/WebGoat)
...
>  然后访问http://ip:2004/WebGoat/和http://ip:2005/WebWolf/
